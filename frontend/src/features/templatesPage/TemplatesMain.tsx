          ...
          <div className="flex items-start gap-3">
            ...
            <div className="w-full">
              ...
              <p className="text-blue-200 text-sm mb-2">
                Templates are reusable collections of grading criteria that you
                can import into rubrics. Create a template once and use it
                across multiple assignments!
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-3">
                <div className="bg-blue-950 bg-opacity-50 rounded p-2">
                  <p className="text-blue-100 font-semibold text-xs mb-1">
                    📝 Create Template
                  </p>
                  <p className="text-blue-300 text-xs">
                    Click "Create Template" below to build a new reusable
                    template
                  </p>
                </div>
                <div className="bg-blue-950 bg-opacity-50 rounded p-2">
                  ...
                  <p className="text-blue-300 text-xs">
                    Click a template to expand, then click "Edit" to modify it
                  </p>
                </div>
                <div className="bg-blue-950 bg-opacity-50 rounded p-2">
                  <p className="text-blue-100 font-semibold text-xs mb-1">
                  ...
                  <p className="text-blue-300 text-xs">
                    Organize templates with tags for easy filtering
                  </p>
                </div>
                <div className="bg-blue-950 bg-opacity-50 rounded p-2">
                  <p className="text-blue-100 font-semibold text-xs mb-1">
                  ...
                  <p className="text-blue-300 text-xs">
                    In Rubric Builder, click "Templates" to import criteria
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mt-0 p-10 gap-6 w-full">
        ...
        <div className="bg-gradient-to-br from-blue-900 to-purple-900 border-2 border-blue-500 rounded-lg p-6 mb-6 shadow-xl max-w-3xl mx-auto">
          ...
          <div className="bg-blue-950 bg-opacity-50 rounded-lg p-4 mb-4">
            <h3 className="text-blue-100 font-bold mb-2">
              📚 What are Templates?
            </h3>
            <p className="text-blue-200 text-sm">
              Templates are collections of reusable grading criteria. Instead of
              recreating the same criteria for every assignment, create a
              template once and import it into any rubric!
            </p>
          </div>
